...
function initPayloads(){
    ...
    payloads1.push({id: 1, x: 2, y: 27, angle: 90, ll:'wall', ul:'open', rl:'open', bl:'open', battery:95, type:'trans'}); //5
    payloads1.push({id: -1, x: 2, y: 27, angle: 90, ll:'wall', ul:'open', rl:'open', bl:'open', battery:94, type:'trans'}); //6

    commands1.push('b1');  // 1
    commands1.push('b1');  // 2
    commands1.push('b1');  // 3
    commands1.push('r1');  // 4
    commands1.push('NULL'); // 5
    commands1.push('NULL'); // 6
    commands1.push('NULL'); // 7
